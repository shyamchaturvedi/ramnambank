      ...
      <form onSubmit={handleSubmit} className="space-y-10">
        ...
        <div className="pt-6 space-y-4">
          ...
          <button 
            ...
            onClick={async () => {
              try {
                ...
                if (result.user) {
                  ...
                  const branchCode = selectedBlock?.code || 'OD/17/01';
                  const branchName = selectedBlock?.name || 'KENDRAPARA SUB DIVISION';
                  ...
                  await setDoc(doc(db, 'members', uid), {
                    ...
                    district: selectedDistrict || 'Kendrapara',
                    block: branchName,
            ...
            className="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white py-5 rounded-[2rem] flex items-center justify-center gap-3 text-[10px] font-black uppercase tracking-widest transition-all active:scale-95 disabled:opacity-50"
          >
